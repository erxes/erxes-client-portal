...
export default App => {
  return class Apollo extends React.Component<any> {
    ...
    static async getInitialProps(ctx) {
      ...
      const apiApollo = initApollo(API_LINK_OPIONS, {});

      ctx.ctx.apolloClient = apollo;
      ctx.ctx.apiClient = apiApollo;
      ...
      const apiApolloState = apiApollo.cache.extract();
    ...
    constructor(props) {
      ...
      this.apiClient = initApollo(API_LINK_OPIONS, props.apiApolloState);
    }
